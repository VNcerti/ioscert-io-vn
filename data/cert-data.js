...
export const certItems = [
  {
    id: 'cert-XL AXIATA, PT TBK',
    title: 'XL AXIATA, PT TBK',
    company: 'Password : chungchip12.com',
    icon: 'fas fa-certificate',
    badge: true,
    statusDot: true,
    url: 'https://link4m.net/4bEsHZI'
  },
  {
    id: 'cert-National Oilwell Varco, Inc.',
    title: 'Certificate File',
    company: 'National Oilwell Varco, Inc.',
    icon: 'fas fa-certificate',
    url: 'https://link4m.com/uv7KL'
  },
  {
    id: 'cert-Forevermark  Marketing(Shanghai) Limited',
    title: 'Certificate File',
    company: 'Forevermark  Marketing(Shanghai) Limited',
    icon: 'fas fa-certificate',
    url: 'https://link4m.com/7wLhdwD'
  },
  {
