...
export const esignItems = [
  ...
  {
    id: 'esign-Aramco Services Company',
    title: 'ESign 5.0.2 (HOT)',
    company: 'Aramco Services Company',
    icon: 'fas fa-signature',
    badge: true,
    statusDot: true,
    url: 'https://vsacheat.com/view.html?id=h4IgRqPs'
  },

  {
    id: 'esign-XL AXIATA, PT TBK',
    title: 'ESign 5.0.2 (chưa thu hồi)',
    company: 'XL AXIATA, PT TBK',
    icon: 'fas fa-signature',
    url: 'https://vsacheat.com/view.html?id=VPXzfMUc'
  },


  {
    id: 'esign-Beijing Zhizhangyi Inc.',
    title: 'ESign 5.0.2',
    company: 'Beijing Zhizhangyi Inc.',
    icon: 'fas fa-signature',
        url: 'https://vsacheat.com/view.html?id=VPXzfMUc'
  },
  
  {
    id: 'esign-National Oilwell Varco, Inc.',
    title: 'ESign 5.0.2',
    company: 'National Oilwell Varco, Inc.',
    icon: 'fas fa-signature',
    url: 'https://link4m.com/e2ZVSSQc'
  },
  {
